...
class __TwigTemplate_b9d9a1b3b1845d07db6bb57a894734a1156844852be750b23702dc95186f028d extends Twig_Template
{
    private $source;
    ...
    <table class=\"table table-hover table-striped mt-3\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["clientes"]) || array_key_exists("clientes", $context) ? $context["clientes"] : (function () { throw new Twig_Error_Runtime('Variable "clientes" does not exist.', 23, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["cliente"]) {
            ...
            echo "</a></td>
                <td>";
            // line 27
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["cliente"], "email", array()), "html", null, true);
            echo "</td>
            </tr>
            ";
...
{% block body %}
    ...
    <table class=\"table table-hover table-striped mt-3\">
        ...
        <tbody>
            ...
            <tr>
                <td>{{cliente.id}}</td>
                <td><a href=\"{{ path('visualizar_cliente', {'id':cliente.id}) }}\">{{cliente.nome}}</a></td>
                <td>{{cliente.email}}</td>
            </tr>
            {% else %}
                <tr>
...
{% endblock %}
", "clientes/index.html.twig", "/var/www/templates/clientes/index.html.twig");
    }
}
