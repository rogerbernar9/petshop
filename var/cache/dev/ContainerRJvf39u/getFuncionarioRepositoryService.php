...
// Returns the private 'App\Repository\FuncionarioRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FuncionarioRepository.php';

return $this->privates['App\Repository\FuncionarioRepository'] = new \App\Repository\FuncionarioRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
