 ...
 */
class Raca extends \App\Entity\Raca implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Raca' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Raca' . "\0" . 'nome', '' . "\0" . 'App\\Entity\\Raca' . "\0" . 'especie'];
        }
    ...
    public function getNomeEspecie()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomeEspecie', []);

        return parent::getNomeEspecie();
    }
