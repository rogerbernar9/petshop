...
// Returns the private 'App\Repository\RacaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RacaRepository.php';

return $this->privates['App\Repository\RacaRepository'] = new \App\Repository\RacaRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
